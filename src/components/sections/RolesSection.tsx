  ...
  return (
    <section id="team" className="section-padding bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <Reveal className="surface-forest mt-16 flex flex-col items-center justify-between gap-6 rounded-3xl px-8 py-10 shadow-lg md:flex-row">
          ...
          <a href="#contact" className="pill-btn pill-btn--primary shrink-0 whitespace-nowrap hover:scale-105">
            {t("hiring.cta")}
          </a>
        </Reveal>
      </div>
